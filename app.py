...
MQTT_PORT = 1883
ZIGBEE_BULB_TOPIC = "zigbee2mqtt/my_nous_bulb/set" # Update to your bulb's friendly name
...
with col1:
    ...
    render_ambient_light(current_rgb if enabled else (30, 30, 30))
...
if uploaded_audio is not None and enabled:
    ...
    with st.spinner("Separating voices and analyzing emotion..."):
        try:
            ...
            # Run Diarization
            diarization = diarizer(tmp_file_path)
            
            # Load audio for splicing
